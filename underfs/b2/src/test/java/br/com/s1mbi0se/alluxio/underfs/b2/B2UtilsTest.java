...
public final class B2UtilsTest
{
    ...
    public void translateUserReadPermission()
    {
        ...
        B2Allowed readAllowed = new B2Allowed(Arrays.asList(
                B2Capabilities.LIST_BUCKETS, B2Capabilities.LIST_FILES, B2Capabilities.READ_FILES, B2Capabilities.SHARE_FILES),
    ...
    public void translateUserWritePermission()
    {
        ...
        B2Allowed writeAllowed = new B2Allowed(Arrays.asList(
                B2Capabilities.DELETE_FILES, B2Capabilities.LIST_BUCKETS, B2Capabilities.WRITE_FILES),
                BUCKET_ID, BUCKET_NAME, "");
        // Assert
    ...
    public void translateUserFullPermission()
    {
        ...
        B2Allowed fullAllowed = new B2Allowed(Arrays.asList(
                B2Capabilities.DELETE_FILES, B2Capabilities.LIST_BUCKETS, B2Capabilities.LIST_FILES,
